...
const App = () => {
  ...
  const styleActiveKey = (key) => {
    key.parentElement.style.backgroundColor = "#D1495B"
    key.parentElement.style.color = "#FDC5F5"
  }
  
  const deActivatedKey = (audio) => {
    audio.parentElement.style.backgroundColor = "#FDC5F5"
    audio.parentElement.style.color = "#D1495B"
  }
